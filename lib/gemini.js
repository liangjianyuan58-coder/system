...
function getKnowledge() {
  if (ACTIVE_MODULE === 'studentMentality') return STUDENTMENTALITY_KNOWLEDGE;
  return HAVEFUN_KNOWLEDGE;
}
function getPersona() {
  if (ACTIVE_MODULE === 'studentMentality') return STUDENTMENTALITY_PERSONA;
  return PERSONA;
}
